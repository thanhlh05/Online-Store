...
INSERT INTO "public"."product_info" VALUES ('C0003', 2, '2018-03-10 12:12:46', 'Mans', 'https://cdn.mos.cms.futurecdn.net/DAxM3MTvoHzHsdo9tiHUHW.jpg', 'Coats', 22.00, 0, 222, '2018-03-10 12:12:46');
...
INSERT INTO "public"."product_info" VALUES ('F0001', 1, '2018-03-10 12:15:05', 'Kids Party Food', 'https://www.tasteofhome.com/wp-content/uploads/2018/01/Crispy-Fried-Chicken_EXPS_TOHJJ22_6445_DR-_02_03_11b-14.jpg', 'Chicken', 4.00, 0, 57, '2018-03-10 12:15:10');
...
-- Records of users
-- ----------------------------
INSERT INTO "public"."users" (id, email, password, name, phone, address, active, role) VALUES (2147483641, 'customer1@email.com', '$2a$10$PrI5Gk9L.tSZiW9FXhTS8O8Mz9E97k2FZbFvGFFaSsiTUIl.TCrFu', 'customer1', '123456789', '3200 West Road', true, 'ROLE_CUSTOMER');
INSERT INTO "public"."users" (id, email, password, name, phone, address, active, role) VALUES (2147483642, 'manager1@email.com', '$2a$10$PrI5Gk9L.tSZiW9FXhTS8O8Mz9E97k2FZbFvGFFaSsiTUIl.TCrFu', 'manager1', '987654321', '2000 John Road', true, 'ROLE_MANAGER');
INSERT INTO "public"."users" (id, email, password, name, phone, address, active, role) VALUES (2147483643, 'employee1@email.com', '$2a$10$PrI5Gk9L.tSZiW9FXhTS8O8Mz9E97k2FZbFvGFFaSsiTUIl.TCrFu', 'employee1', '123123122', '222 East Drive', true, 'ROLE_EMPLOYEE');
INSERT INTO "public"."users" (id, email, password, name, phone, address, active, role) VALUES (2147483645, 'customer2@email.com', '$2a$10$0oho5eUbDqKrLH026A2YXuCGnpq07xJpuG/Qu.PYb1VCvi2VMXWNi', 'customer2', '2343456', '3100 Western Road A', true, 'ROLE_CUSTOMER');
